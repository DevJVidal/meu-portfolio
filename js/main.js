...
const translations = {
  pt: {
    ...
    "proj2-title": "Landing Page Vitor Couto",
    "proj2-desc": "Uma solução digital de alta performance desenvolvida sob medida para Personal Trainers e Treinadores de Elite que desejam posicionar seu trabalho como um serviço premium, triar potenciais clientes de forma automatizada e fechar consultorias de alto valor diretamente pelo WhatsApp.",
  ...
  en: {
    ...
    "proj2-title": "Landing Page Vitor Couto",
    "proj2-desc": "A high-performance digital solution custom-built for personal trainers and elite coaches who want to position their work as a premium service, automatically screen potential clients, and close high-value consulting deals directly via WhatsApp.",
